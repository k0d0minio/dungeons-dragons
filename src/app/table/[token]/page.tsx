...
/**
 * The shared table screen (D24). **Public by design** — `/table/*` is one of
 * the named exceptions in `src/proxy.ts`'s deny-by-default wall (D34), and it
 * has to stay one: the token in the URL is the whole credential, and what it
 * unlocks is only the sanitized view the data layer builds (initiative order,
 * conditions, PC HP — never monster HP).
